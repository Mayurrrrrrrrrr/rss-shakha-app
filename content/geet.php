...
function getGeetHtml($item) {
    ...
    $currentUrl = "https://sanghasthan.yuktaa.com/geet/#item-" . $item['id'];
    $shareText = "🎵 *" . $item['title'] . "* 🎵\n\n" . mb_substr($item['lyrics'], 0, 200) . "...\n\nविस्तार से पढ़ें: " . $currentUrl . "\n\n🚩 *संघस्थान*";
...
<div class="public-header">
    <h1>🎵 गीत</h1>
    <p>राष्ट्रभक्ति और सांस्कृतिक गीतों का संग्रह</p>
</div>
...
<?php else: ?>
    <div class="list-container">
        <?php foreach ($items as $index => $item): 
            ...
            $isLatest = ($index === 0);
        ?>
            <div class="list-item" id="item-<?php echo $item['id']; ?>" style="<?php echo $isLatest ? 'border-left:4px solid var(--green-deep); background:rgba(46,125,50,0.03);' : ''; ?>" 
                 data-side-title="गीत" 
