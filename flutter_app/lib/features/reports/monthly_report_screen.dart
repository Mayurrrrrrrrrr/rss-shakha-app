      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(value, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF5D4037))),
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text(category, style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF5D4037))),
